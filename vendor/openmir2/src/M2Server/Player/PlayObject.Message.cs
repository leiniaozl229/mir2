    ...
    public partial class PlayObject
    {
        public override void Run()
        {
            ...
            try
            {
                if (Dealing)
                {
                    if (DealCreat == this || DealCreat == null ||
                        (GetPoseCreate() != DealCreat &&
        ...
        protected override bool Operate(ProcessMessage processMsg)
        {
            ...
            switch (processMsg.wIdent)
            {
                ...
                case Messages.CM_GROUPMODE:
                    ...
                    break;
                case Messages.CM_ATTACKMODE:
                    if (processMsg.nParam2 is >= (int)AttackMode.HAM_ALL and <= (int)AttackMode.HAM_PKATTACK)
                    {
                        AttatckMode = (AttackMode)processMsg.nParam2;
                    }
                        ...
                        if (stdItem != null)
                        {
                            if ((stdItem.ItemDesc & 10) == 0)
                            {
                                if (Race == ActorRace.Play)
                                {
                                    ...
                                    {
                                        ItemName = SystemShare.ItemSystem.GetStdItemName(UseItems[i].Index),
        ...
        private void UseLamp()
        {
            ...
            try
            {
                ...
                {
                    StdItem stdItem = SystemShare.ItemSystem.GetStdItem(UseItems[ItemLocation.RighThand].Index);
