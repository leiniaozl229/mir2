...
export class RepairView{
 private npcId:number|undefined;private items:InventoryItem[]=[];private quote:{item:InventoryItem;price:number}|undefined;private pending:number|undefined;private icons:Awaited<ReturnType<typeof loadFallbackItemIcons>>|undefined;private nationalIcons:Awaited<ReturnType<typeof loadNationalUiLibrary>>|undefined;
