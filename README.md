...
国服 UI 校准页：http://127.0.0.1:5173/ui-calibration.html 。页面固定 800×600 设计坐标，提供登录、选角、创建角色、主 HUD、角色窗、背包窗和 NPC 对话场景；可以载入国服截图作透明叠加，打开 16px 网格和坐标尺，鼠标位置会显示设计坐标。联机页也会按同一设计坐标整体缩放，不改变游戏内控件位置。
